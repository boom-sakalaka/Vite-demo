<!--
 * @Author: GZH
 * @Date: 2021-08-25 15:54:16
 * @LastEditors: GZH
 * @LastEditTime: 2021-08-25 15:59:15
 * @FilePath: \Vite-demo\newbee-admin\src\components\DialogAddCategory.vue
 * @Description: 
-->
<template>
...
import { ElMessage, ElDialog, ElInput, ElForm, ElFormItem, ElButton } from 'element-plus';
export default {
  ...
  components: { ElDialog, ElInput, ElForm, ElFormItem, ElButton },
  setup(props) {

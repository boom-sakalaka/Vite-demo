<!--
 * @Author: GZH
 * @Date: 2021-08-26 10:44:45
 * @LastEditors: GZH
 * @LastEditTime: 2021-08-26 10:49:04
 * @FilePath: \Vite-demo\newbee-admin\src\views\OrderDetail.vue
 * @Description: 
-->
<template>
...
<script>
import { ElCard, ElTableColumn, ElTable } from 'element-plus';
import { onMounted, reactive, toRefs } from 'vue';
import { useRoute } from 'vue-router';
import axios from '@/utils/axios';
export default {
  name: 'OrderDetail',
  components: { ElCard, ElTableColumn, ElTable },
  setup() {
